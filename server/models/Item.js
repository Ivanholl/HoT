...
var itemSchema = mongoose.Schema({
    ...
    class: String,
    pic: String,
    rarity: String, //rare<epic<legendary,setItem,unique<quest
...
module.exports.seedInitialItems = function() {
    ...
    //potions
            Item.create({title:"Small Health Potion",rarity: 'common', type: "consumable", stackable:"yes", weight:"1", class:"health potion", bonus:['5 HP','restores'], price:25, pic:"/pictures/items/SmallHpPotion.jpg"});
