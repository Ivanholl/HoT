...
module.exports.seedInitialItems = function() {
    ...
    //spears
            ...
            Item.create({title:"Basic Spear", rarity: 'common',type: 'weapon', weight:'1', class:'spear', twoHands:true, bonus:['maxDm','1','maxHp','1'],price:100, pic: "/pictures/items/BasicSpear.png"});
    //axes
    ...
    //wands
            Item.create({title:"Simple Cane", rarity: 'common',type: 'weapon', weight:'1', class:'wand', bonus:['maxDm','1'],price:70, pic: "/pictures/items/SimpleCane.png"});
            Item.create({title:"Priest Rod", rarity: 'common', type: 'weapon', weight:'2', class:'wand', bonus:['maxDm','2'],price:144, pic: "/pictures/items/PriestRod.png"});
    //daggers
            Item.create({title:"Bread Knife", rarity: 'common', type: 'double-weapon', weight:'1', class:'dagger', bonus:['maxDm','1'], secBonus:['maxDm','2'], price:75, pic: "/pictures/items/BreadKnife.png"});
            Item.create({title:"Wicked Knife", rarity: 'common', type: 'double-weapon', weight:'2', class:'dagger', bonus:['maxDm','2'], secBonus:['maxDm','2','maxMp','2'], price:230, pic: "/pictures/items/WickedKnife.png"});
    //shields
